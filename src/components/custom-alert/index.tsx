...
export const callAlert = ({
  ...
  MySwal.fire({
    customClass: {
      container: "z-[999999]",
      htmlContainer: "!m-0 ",
      actions: "mt-4 flex gap-4",
      confirmButton: "btn-primary",
      cancelButton: "btn-disabled",
    },
    html: `<div style="color: #000000; padding-bottom: 20px;" class="border-b-[1.5px]"><p class="text-3xl font-medium">${title}</p><div style="color:#48505E; font-size:16px; margin-top:10px;padding-left: 0.9rem;padding-right:0.9rem">${message}</div></div>`,
    icon,
    iconColor,
    width: 400,
